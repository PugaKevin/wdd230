const apiURL = `https://api.openweathermap.org/data/2.5/weather?id=5585010&units=imperial&APPID=1de9fc6716174ce6e8044634a4474860`;
fetch(apiURL)
...
const forecastURL = `https://api.openweathermap.org/data/2.5/forecast?id=5585010&units=imperial&appid=1de9fc6716174ce6e8044634a4474860`;
fetch(forecastURL)
    .then((response) => response.json())
    .then((forecast) => {
